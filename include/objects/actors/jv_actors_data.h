...
namespace jv::Actor_data{
    enum Id {Player, Bad_Cat, Pale_Tongue, Pale_Finger, Snakes, Cow, Fox, Tree};
    ...
    constexpr bn::array<meta_data, ACTOR_COUNT> meta = {
        ...
        meta_data( 8, 0,46,20,60,{16, 16},{16, 16}),  // pale tongue
        meta_data(24, 0,70,40,76,{32, 58},{16, 16}),  // pale finger
        meta_data(-2, 1,46,18,60,{16, 16},{12, 32}),  // snakes
        meta_data( 8, 1, 1, 1, 1,{16, 16},{20, 20}),  // cow
        meta_data( 8, 0, 1, 1, 1,{16, 16},{20, 20}),  // fox
        meta_data( 8, 0, 1, 1, 1,{30, 30},{16, 16})   // tree
    };
