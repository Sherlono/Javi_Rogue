...
PYTHON      :=  python
SOURCES     :=  source source/functionality source/objects source/objects/actors ../../butano/common/source
INCLUDES    :=  include include/functionality include/objects include/objects/actors include/scenes ../../butano/common/include
DATA        :=
GRAPHICS    :=  graphics graphics/intro_movie graphics/actors graphics/objects graphics/bg_tiles ../../butano/common/graphics
